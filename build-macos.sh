...
cp "$ROOT/index.html" "$ROOT/styles.css" "$ROOT/game.js" "$ROOT/version.json" "$ROOT/manifest.webmanifest" "$ROOT/manifest-3d.webmanifest" "$CONTENTS/Resources/"
...
cp -R "$ROOT/Assets/pwa" "$CONTENTS/Resources/Assets/"
